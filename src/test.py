...
try:
    ...
    calibrations.append(load_calibration("temp_0.data"))
    calibrations.append(load_calibration("temp_1.data"))
    calibrations.append(load_calibration("temp_2.data"))
    ...
    pts = []
    dirs = []
    paths = load_batch("../mesures/tracking_blender_2/*.png")
